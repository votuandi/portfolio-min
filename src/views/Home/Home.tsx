    ...
    <>
      ...
      <BannerSection>
        <Grid container sx={{ height: '100vh', width: '100%', background: '#C2E5F0' }}>
          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'start', lineHeight: 1.2 }}>
      ...
      <HomeSection maxWidth={'xl'}>
        ...
        <p style={{ fontFamily: 'Open Sans', maxWidth: '880px', textAlign: 'center', lineHeight: 1.6, fontSize: isMobile ? '16px' : '18px' }}>
          ...
          trường, tôi mong muốn tìm kiếm cơ hội làm việc trong môi trường chuyên nghiệp để tiếp tục phát triển kỹ năng và học hỏi thêm về ngành truyền thông. Tôi đặc biệt quan tâm
          đến lĩnh vực sáng tạo nội dung, marketing số và quản lý dự án truyền thông, mong muốn đóng góp giá trị cho doanh nghiệp qua những ý tưởng sáng tạo, cập nhật xu hướng mới
          và tinh thần học hỏi không ngừng.
        </p>
        <span style={{ fontFamily: 'Cormorant', fontSize: '20px', fontWeight: 500 }}> - Võ Tuyết Minh -</span>
      </HomeSection>
      <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <HomeSection maxWidth={'xl'}>
          <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'start', alignItems: 'center', gap: '12px' }}>
            <img src="/img/edu.webp" alt="" style={{ width: '80px' }} />
